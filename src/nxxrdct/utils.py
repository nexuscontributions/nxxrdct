...
def get_quantity(
    ...
    """
    Return the value and unit of an HDF5 dataset. If the unit is not found,
    fall back on `default_unit`.
    ...
    :param default_unit: default unit to use if the dataset has no ``unit``
        or ``units`` attribute.
